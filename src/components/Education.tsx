...
const Education = () => {
  ...
  return (
    <section ref={sectionRef} id="education" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            My educational journey in building a strong foundation in data science and artificial intelligence
          </p>
        </div>

        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-1/2 transform -translate-x-px h-full w-0.5 bg-gradient-to-b from-blue-300 via-blue-500 to-blue-700"></div>

          <div className="space-y-12">
            {educationData.map((item, index) => (
              <div
                key={index}
                className={`timeline-item opacity-0 translate-y-10 scale-95 transition-all duration-700 relative flex items-center ${
                  index % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"
                }`}
              >
                {/* Timeline Icon */}
                <div className="absolute left-1/2 transform -translate-x-1/2 w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center shadow-lg z-10 border-4 border-white animate-pulse">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 border-l-4 border-blue-600 hover:scale-[1.02]">
                    ...
                    {item.grade && (
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-orange-600 font-medium">{item.grade}</span>
                      </div>
                    )}
